...
define([
    ...
    'kb_widgets/kbwidget',
    'kb_widgets/authenticatedWidget',
    'narrativeConfig',
    ...
    return KBWidget({
        ...
        init: function (options) {
            ...
            self.genericClient.sync_call('ServiceWizard.get_service_status', [{ 'module_name': 'GenomeSearchUtil', 'version': 'release' }],
                function (status) {
        ...
        */
        buildGeneSearchView: function (params) {
            ...
            var idClick = params.idClick || null;

            var contigClick = params.contigClick || null;
            ...
            function buildTableHeader() {
                ...
                function buildSingleColHeader(key, title, width, showSortedIcon, sortEvent, target) {
        ...
        */
        buildContigSearchView: function (params) {
            ...
            function showViewInfo(start, num_showing, num_found) {
                $resultsInfoDiv.empty();
                $resultsInfoDiv.append('Showing ' + (start + 1) + ' to ' + (start + num_showing) + ' of ' + num_found);
            }
